...
<form class="center1 , mt-2 , mb-2">
    <form>
        <a class="btn , btn-dark , border , border-secondary" href="shopclass.php"> Классика</a>
        <a class="btn , btn-dark , border, disabled , border-secondary" href="shopcard.php"> Карточные</a> &nbsp | &nbsp
...
<div class="container" id="contik" name="contik">
    ...
    $result = mysqli_query($conn, "Select * From `product` where `type`='card'");
    $i = 0;
    $j = 0;
